...
public class InterfazGrafica extends javax.swing.JFrame {
    ...
    public InterfazGrafica() {
        ...
        ImageIcon imagen = new ImageIcon(new ImageIcon("argon.gif").getImage().getScaledInstance(48, 36, Image.SCALE_DEFAULT));
        for (int i = 0; i < 118; i++) { 
    ...
    private void boroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_boroActionPerformed
        ...
        try {
            VentanaInformacion frame = new VentanaInformacion(elementoBoton);
